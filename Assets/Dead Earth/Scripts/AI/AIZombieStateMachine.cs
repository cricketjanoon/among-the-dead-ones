...
public class AIZombieStateMachine : AIStateMachine
{
    ...
    [SerializeField]
    [Range(0.0f, 1.0f)]
    private float _sight = 0.5f;

    [SerializeField]
    [Range(0.0f, 1.0f)]
    private float _hearing = 1.0f;
    ...
    [SerializeField]
    [Range(0, 100)]
    private int _lowerBodyDamage = 0;

    [SerializeField]
    [Range(0, 100)]
    private int _upperBodyDamage = 0;

    [SerializeField]
    [Range(0, 100)]
    private int _upperBodyThreshold = 30;

    [SerializeField]
    [Range(0, 100)]
    private int _limpThreshold = 30;

    [SerializeField]
    [Range(0, 100)]
    private int _crawlThreshold = 90;

    [SerializeField]
    [Range(0.0f, 1.0f)]
    private float _intelligence = 0.5f;
    ...
    [SerializeField]
    [Range(0.0f, 1.0f)]
    private float _screamChance = 1.0f;

    [SerializeField]
    [Range(0.0f, 50.0f)]
    private float _screamRadius = 20.0f;

    [SerializeField]
    private AIScreamPosition _screamPosition = AIScreamPosition.Entity;

    [SerializeField]
    private AISoundEmitter _screamPrefab = null;

    [SerializeField]
    private AudioCollection _ragdollCollection = null;

    [SerializeField]
    private float _replenishRate = 0.5f;

    [SerializeField]
    private float _depletionRate = 0.1f;

    [SerializeField]
    private float _reanimationBlendTime = 1.5f;

    [SerializeField]
    private float _reanimationWaitTime = 3.0f;

    [SerializeField]
    private LayerMask _geometryLayers = 0;

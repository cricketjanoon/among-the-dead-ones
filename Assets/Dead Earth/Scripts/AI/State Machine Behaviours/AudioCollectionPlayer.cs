...
public class AudioCollectionPlayer : AIStateMachineLink
{
    // Inspector Assigned
    [SerializeField]
    private ComChannelName _commandChannel = ComChannelName.ComChannel1;

    [SerializeField]
    private AudioCollection _collection = null;

    [SerializeField]
    private CustomCurve _customCurve = null;

    [SerializeField]
    private StringList _layerExclusions = null;

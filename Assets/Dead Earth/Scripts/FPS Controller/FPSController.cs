...
public class CurveControlledBob
{
	...
	[SerializeField]
	private float _baseInterval = 1.0f;
...
{
	[SerializeField]
	private AudioCollection _footsteps = null;

	[SerializeField]
	private float _crouchAttenuation = 0.2f;
	...
	[SerializeField]
	private float _staminaDepletion = 5.0f;

	[SerializeField]
	private float _staminaRecovery = 10;
	...
	[SerializeField]
	private bool _flashlightOnAtStart = true;

	// Use Standard Assets Mouse Look class for mouse input -> Camera Look Control
	[SerializeField]
	private UnityStandardAssets.Characters.FirstPerson.MouseLook _mouseLook = new UnityStandardAssets.Characters.FirstPerson.MouseLook();
	...
	protected void FixedUpdate()
	{
		...
		//_isWalking = !(Input.GetKey(KeyCode.LeftShift) || Input.GetButtonDown("Run"));

...
public class PlayerHUD : MonoBehaviour
{
    ...
    [SerializeField]
    private bl_ProgressBar _healthBar = null;

    [SerializeField]
    private bl_ProgressBar _staminaBar = null;

    [SerializeField]
    private Text _interactionText = null;
    ...
    [SerializeField]
    private float _missionTextDisplayTime = 3.0f;
    ...
    public void Invalidate(CharacterManager charManager)
    {
        ...
        if (_healthBar) _healthBar.Value = (int)charManager.health;
        if (_staminaBar) _staminaBar.Value = (int)charManager.stamina;
    }

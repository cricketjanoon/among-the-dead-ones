...
public class AnimatorConfigurator
{
    ...
    [SerializeField]
    public List<AnimatorParams> animatorParameter = new List<AnimatorParams>();
}
...
public class InteractiveGenericSwitch : InteractiveItem
{
    ...
    [SerializeField]
    protected List<GameState> _activateStates = new List<GameState>();

    [SerializeField]
    protected List<GameState> _deactivateStates = new List<GameState>();

    [Header("Message")]
    [TextArea(3, 10)]
    [SerializeField]
    protected string _stateNotSetText = "";

    [TextArea(3, 10)]
    [SerializeField]
    protected string _stateSetText = "";

    [TextArea(3, 10)]
    [SerializeField]
    protected string _ObjectActiveText = "";

    //Activation Sound
    [Header("Activation Parameter")]
    [SerializeField]
    protected float _activationDelay = 1.0f;

    [SerializeField]
    protected float _deactivationDelay = 1.0f;

    [SerializeField]
    protected AudioCollection _activationSounds = null;
    ...
    [SerializeField]
    protected bool _startActivated = false;

    [SerializeField]
    protected bool _canToggle = false;
    ...
    protected virtual IEnumerator DoDelayedActivation()
    {
        ...
        foreach (AnimatorConfigurator configurator in _animations)
        {
            ...
            {
                foreach (AnimatorParams param in configurator.animatorParameter)
                {

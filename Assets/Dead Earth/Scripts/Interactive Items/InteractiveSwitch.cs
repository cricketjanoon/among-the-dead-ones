...
{
    [SerializeField]
    protected Transform _elevator = null;

    [SerializeField]
    protected AudioCollection _collection = null;
    ...
    public override void Activate(CharacterManager characterManager)
    {
        ...
        //string powerState = appDatabase.GetGameState("POWER");
        //string dataState = appDatabase.GetGameState("LOCKDOWN");
        //string accessCodeState = appDatabase.GetGameState("ACCESSCODE");

        //if (string.IsNullOrEmpty(powerState) || !powerState.Equals("TRUE")) return;
        //if (string.IsNullOrEmpty(dataState) || !dataState.Equals("TRUE")) return;

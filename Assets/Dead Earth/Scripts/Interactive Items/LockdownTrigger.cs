...
{
    [SerializeField]
    protected float _downloadTime = 10.0f;

    [SerializeField]
    protected Slider _downloadBar = null;

    [SerializeField]
    protected Text _hintText = null;

    [SerializeField]
    protected MaterialController _materialController = null;

    [SerializeField]
    protected GameObject _lockedLight = null;

    [SerializeField]
    protected GameObject _unlockedLight = null;
